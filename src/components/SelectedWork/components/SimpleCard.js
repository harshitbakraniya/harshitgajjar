...
export function SimpleCard({ ...card }) {
  return (
    <div
      className={`relative flex min-h-[70vh] w-full flex-col items-center justify-center px-6 py-16 sm:px-10 sm:py-20 ${card.bg}`}
    >
      <div className="flex w-full max-w-md mt-auto flex-col items-center">
        <Image
          ...
          width={1000}
          height={700}
          className="w-full rounded-2xl border-4 border-white/40 object-cover"
        />
