...
function DesktopStack() {
  ...
  return (
    ...
    >
      {showCursor && (
        <div
          className="pointer-events-none fixed left-0 top-0 z-[9999] flex h-20 w-20 select-none items-center justify-center rounded-full bg-white text-xs font-semibold text-black shadow-xl"
          style={{
